# VideoCompress
A Telegram Video Compressor Bot By [@AbdullahTN](https://t.me/Doraemon_Tamil). **This bot works for all!** No need to define each user IDs to use bot. Also works in Group.
